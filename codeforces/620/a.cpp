							...
							<form class="form-horizontal" method="GET" action="{{ route('admin.articles.search') }}">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="title_search" id="title_search" 
											       value="{{(isset($inputs['title_search'])) ? $inputs['title_search'] : ''}}">
											       <div style="height:25px;color:green;font-size:12px;" id="errorArticleTitle"></div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8">
											<select name="status_search" class="form-control">
												<option
														value="100" {{(isset($inputs['status_search']) && $inputs['status_search'] == 100) ? "selected" : ''}}>
													- Please select -
												</option>
												<option
														value="1" {{(isset($inputs['status_search']) && $inputs['status_search'] == 1) ? "selected" : ''}}>
													Active
												</option>
												<option
														value="0" {{(isset($inputs['status_search']) && $inputs['status_search'] == 0) ? "selected" : ''}}>
													Inactive
												</option>
											</select>
										</div>
								...
								<div class="col-md-6">
										...
										<div class="col-md-8">
											<div class="input-group">
												<input type="text" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"
												       class="form-control datepicker-d" name="post_date_search"
												       value="{{(isset($inputs['post_date_search'])) ? $inputs['post_date_search'] : ''}}"/>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="author_search"
											       value="{{(isset($inputs['author_search'])) ? $inputs['author_search'] : ''}}">
										</div>
									</div>
								</div>
								<!-- end col-md 6 -->
								...
								<div class="form-actions text-center">
									<button type="submit" onclick="return getSerach();" class="btn btn-red">Search &nbsp;<i class="fa fa-search"></i></button>
								</div>
								<!-- save button end -->
							</form>
						</div>
				...
				<div class="col-lg-12">
					<div class="portlet">
						<div class="portlet-header">
							...
							<a href="#" data-target="#modal-add-article" data-toggle="modal" class="btn btn-success">Add New
							...
							<div class="btn-group">
								...
								<ul role="menu" class="dropdown-menu">
									<li><a href="#" data-target="#modal-delete-selected" data-toggle="modal">Delete selected item(s)</a>
									</li>
									<li class="divider"></li>
							...
							<div id="modal-add-article" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
												...
												<form class="form-horizontal" id="form-add-article" method="POST">
													...
													<div class="form-group">
														...
														<div class="col-md-3">
															<div class="input-group">
																<input type="text" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"
																       class="datepicker-d form-control readonly-with-cursor" readonly='true'
																       name="post_date" id="post_date_create"/>
																<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-6">
															<input type="text" class="form-control" placeholder="eg. Hock" name="author"
															       id="author_create">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label">Upload Author Thumbnail <span
																	class="text-red">*</span></label>
														<div class="col-md-9">
															<div class="xs-margin"></div>
															<input type="file" name="author_thumbnail" id="author_thumbnail_create"/>
															<span
																	class="help-block">(Image dimension: 100 x 100 pixels, JPEG/GIF/PNG only, Max. 1MB) </span>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-9">
															...
															<span
																	class="help-block">(Image dimension: 560 x 250 pixels, JPEG/GIF/PNG only, Max. 1MB) </span>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-3 control-label">Article Content</label>
														<div class="col-md-9">
															<div class="text-blue border-bottom">You can edit the content by clicking the text
																below.
															</div>
													...
													<div class="form-actions">
														<div class="col-md-offset-5 col-md-8">
															<button class="btn btn-red add-article" type="submit">Save &nbsp;<i
																		class="fa fa-floppy-o"></i></button>&nbsp; <a href="#" data-dismiss="modal"
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 id="modal-login-label4" class="modal-title"><a href=""><i
															class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete the selected
												item(s)? </h4>
										</div>
										<div class="modal-body">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
											<h4 id="modal-login-label4" class="modal-title"><a href=""><i
															class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete all items?
											</h4>
										</div>
										<div class="modal-body">
											<div class="form-actions">
									...
									<div class="form-group">
										...
										<select name="select" class="form-control" name="per_page" id="per_page">
											@foreach($list_pages as $lg)
												<option
														{{ ($select_page == $lg) ? 'selected="selected"' : '' }} value="{{ $lg }}">{{ $lg }}</option>
											@endforeach
										</select>
										&nbsp;
								...
								<div class="table-responsive mtl">
									...
									<input type="hidden" name="_token" value="{{ csrf_token() }}">
										<table id="example1" class="table table-hover table-striped">
											...
											@foreach($articles as $article)
												<tr>
													...
													<td>{!! ($articles->firstItem() + $x) !!}</td>
													<td class="data-title-id-{{ $article->id }}">{!! $article->title !!}</td>
													<td>{!! $article->post_date_month_in_middle !!}</td>
													<td>{!! $article->author !!}</td>
													<td><span
																class="label label-xs label-{{($article->status == 1) ? 'success':'default'}}">{{($article->status == 1) ? 'Active':'InActive'}}</span>
													</td>
													<td>
														<a href="#" onclick="getArticleById({{$article->id}})" data-target="#modal-edit-article"
														   data-toggle="modal" data-hover="tooltip" data-placement="top" title="Edit"><span
																	class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
														<a href="{{ route('admin.articles.show', $article->id) }}" data-hover="tooltip"
														   data-placement="top" title="View/Reply Comment"><span
																	class="label label-sm label-warning"><i class="fa fa-search"></i></span></a>
														<a href="#" data-hover="tooltip" data-placement="top" title="Delete"
														   data-target="#modal-delete-3" data-toggle="modal"
														   onclick="deleteArticle({{$article->id}})"><span class="label label-sm label-red"><i
										...
										<div class="tool-footer text-right">
											<p class="pull-left">Showing {{ $articles->firstItem() }} to {{ $articles->lastItem() }}
												of {{ $articles->total() }} entries</p>
					...
					<div id="modal-edit-article" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
					     aria-hidden="true" class="modal fade">
						<div class="modal-dialog modal-wide-width">
							<div class="modal-content">
								<div class="modal-header">
								...
								<div class="modal-body">
									<div class="form">
										<form class="form-horizontal form-update-article" method="POST"
										      action="{{route('admin.articles.update')}}">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<div class="input-group">
														<input type="text" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"
														       class="datepicker-d form-control" readonly='true' name="post_date"
														       id="post_date_edit"/>
														<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
													</div>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<div class="author-thumbnail-edit">
														...
														<a href="#" data-hover="tooltip" data-placement="top" title="Delete"
														   data-target="#modal-delete-icon" data-toggle="modal"><span
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Upload Front Image (For Index) <span
															class="text-red">*</span></label>
												<div class="col-md-9">
													<div class="xs-margin"></div>
													<div class="front_image-edit">
														...
														<a href="#" data-hover="tooltip" data-placement="top" title="Delete"
														   data-target="#modal-delete-front-image" data-toggle="modal"><span
																	class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
													</div>
													<div class="xs-margin"></div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Article Content</label>
												<div class="col-md-9">
													<div class="text-blue border-bottom">You can edit the content by clicking the text below.
													</div>
													<div class="margin-top-5px"></div>
													<div class="content_fullwidth">
														<div class="three_fourth">
					...
					<div id="modal-delete-icon" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true"
					     class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
									<h4 id="modal-login-label4" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a>
										Are you sure you want to delete this icon image? </h4>
								</div>
								<div class="modal-body">
									<p><img src="" alt="Author Thumbnail" class="img-responsive author_thumbnail_edit_link"></p>
									<div class="form-actions">
										<div class="form">
											<form class="form-horizontal form-delete-author-thumbnail" method="POST"
											      action="{{route('admin.articles.update')}}">
												<input type="hidden" name="_token" value="{{ csrf_token() }}">
												...
												<div class="col-md-offset-4 col-md-8">
													<button type="submit" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp;
													<a href="#" class="btn btn-green btn_close_author_thumbnail_delete">No &nbsp;<i
																class="fa fa-times-circle"></i></a></div>
											</form>
										</div>
									</div>
					...
					<div id="modal-delete-front-image" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
					     aria-hidden="true" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
								...
								<div class="modal-body">
									...
									<div class="form-actions">
										<form class="form-horizontal form-delete-front-image" method="POST"
										      action="{{route('admin.articles.update')}}">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
											...
											<div class="col-md-offset-4 col-md-8">
												<button type="submit" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp;
												<a href="#" class="btn btn-green btn_close_front_image_delete">No &nbsp;<i
															class="fa fa-times-circle"></i></a></div>
										</form>
									</div>
								</div>
					...
					<!-- modal delete end -->
					<!--Modal delete start-->
					<div id="modal-delete-3" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true"
					     class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
									<h4 id="modal-login-label4" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a>
										Are you sure you want to delete this article? </h4>
								</div>
								<div class="modal-body">
									<p id="article_delete"><strong>#1:</strong> How to reset your email password if you are using cPanel
										emails with Outlook 2010 email client? </p>
									<div class="form">
...
@section('js')
	...
	function getSerach()
	{
		var article_title = $('#title_search').val();
		if(article_title.trim()=='')
		{
			$('#errorArticleTitle').html('Please enter article title');
			setTimeout(function(){$("#errorArticleTitle").html('');},4000)
	    	$("#title_search").focus();
			return false;
		}
      ...
      var csrf_token = $('#token_create').val();
      var base_url = '{{ url() }}';
      ...
      $(document).ready(function () {
          ...
          $('#form-add-article').submit(function (e) {
              ...
              $.ajax({
                  type: 'POST',
                  url: "{{url('admin/blog/articles/store')}}",
